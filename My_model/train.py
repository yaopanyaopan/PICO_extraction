...
tf.flags.DEFINE_float("l2_reg_lambda",0.1,"...")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        to_picture(title='dev-loss', x_content=epoch, y_content=dev_loss, xlabel='Epoch', ylabel='loss', xlim=(0,10) ,ylim=(0,40), path=out_dir+'/dev-loss.png')
        to_picture(title='dev-acc', x_content=epoch, y_content=dev_acc, xlabel='Epoch', ylabel='acc', xlim=(0, 30),ylim=(0,1),
                   path=out_dir + '/dev-acc.png')
        to_picture(title='train-loss', x_content=epoch, y_content=train_loss, xlabel='Epoch', ylabel='loss', xlim=(0, 10),ylim=(0,40),
                   path=out_dir + '/train-loss.png')
        to_picture(title='train-acc', x_content=epoch, y_content=train_acc, xlabel='Epoch', ylabel='acc', xlim=(0, 10),
                   ylim=(0, 1),
